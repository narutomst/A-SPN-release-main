...
from tensorflow.keras.layers import Input, Dense, Reshape, Lambda, Dropout
...
def get_model(img_rows, img_cols, num_PC, nb_classes, dataID=1, type='aspn', lr=0.01):
    ...
    model.compile(optimizer=rmsp, loss=tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True),
