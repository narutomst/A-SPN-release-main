...
# 原版中是 'Dataset/PaviaU.mat'
data_path_dir = {
    '1': [['C:/Matlab练习/duogun/PaviaU.mat', 'paviaU'],
          ['C:/Matlab练习/duogun/PaviaU_gt.mat', 'lbs2']],
    '2': [['C:/Matlab练习/duogun/Indian_pines_corrected.mat', 'indian_pines_corrected'],
          ['C:/Matlab练习/duogun/Indian_pines_gt.mat', 'lbs2']],
    '3': [['C:/Matlab练习/duogun/Houston.mat', 'img'],
          ['C:/Matlab练习/duogun/Houston_gt.mat', 'lbs2']],
}
# "C:\Matlab练习\duogun\Indian_pines_corrected.mat"
# 原版中是 'Dataset/PaviaU.mat'
disjoint_data_path_dir = {
    '1': [['C:/Matlab练习/duogun/PaviaU.mat', 'paviaU'],
          ['C:/Matlab练习/duogun/DS_PaviaU_gt.mat', 'y'],
          ['C:/Matlab练习/duogun/DS_PaviaU_gt2.mat', 'y'], ],
    '2': [['C:/Matlab练习/duogun/Indian_pines_corrected.mat', 'indian_pines_corrected'],
          ['C:/Matlab练习/duogun/DS_Indian_pines_gt.mat', 'y'],
          ['C:/Matlab练习/duogun/DS_Indian_pines_gt2.mat', 'y']],
    '3': [['C:/Matlab练习/duogun/Houston.mat', 'img'],
          ['C:/Matlab练习/duogun/Houston_train_gt.mat', 'y'],
          ['C:/Matlab练习/duogun/Houston_test_gt.mat', 'y']],
}	
...
def get_labels(batchs, step=100, argmax=False):
    Y = []
    idx = 0
    ...
    if argmax:
        ...
        # axis=0表示array的每一列返回一个值，最终结果是一个行向量；
        # axis=1表示array的每一行返回一个值，最终结果是一个列向量；
    else:
        return np.array(Y)
    ...
    def generate_batch(idx, X_PCAMirrow, Y, batch_size, shuffle=False):
        ...
        while True:
            ...
            for i in range(0, num, batch_size):
                ...
                # yield [patches], \
                #       [utils.to_categorical(labels[:, 0], Y.max())]
                yield [patches], labels[:, 0]

    return (generate_batch(train_idx, X_PCAMirrow, Y_train, train_batch_size, shuffle=True), train_step,
            generate_batch(test_idx, X_PCAMirrow, Y_test, batch_size), test_step)
    ...
    def generate_batch(idx, X_PCAMirrow, Y, batch_size, shuffle=False):
        ...
        while True:
            ...
            for i in range(0, num, batch_size):
                ...
                # yield [patches], \
                #       [utils.to_categorical(labels[:, 0], Y.max())]  # , utils.to_categorical(labels[:,0], Y.max())]
                yield [patches], labels[:, 0]
    # shuffle=True
    return (generate_batch(train_idx, X_PCAMirrow, Y, train_batch_size, shuffle=shuffle), train_step,
            generate_batch(test_idx, X_PCAMirrow, Y, batch_size), test_step)
